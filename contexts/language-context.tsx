...
const translations = {
  es: {
    ...
    // CV Module
    'cv.title': 'CV - Hoja de Vida',
    'cv.subtitle': 'Mi experiencia profesional y habilidades',
    'cv.download': 'Descargar',
    'cv.share': 'Compartir',
    'cv.email': 'Enviar por correo',
    'cv.fullscreen': 'Pantalla completa',
    'cv.exitFullscreen': 'Salir de pantalla completa',
    'cv.notAvailable': 'CV no disponible',
    'cv.notFound': 'No se encontró ningún CV activo.',
    'cv.backToHome': 'Volver al inicio',
    'cv.lastUpdated': 'Actualizado',
    'cv.language': 'Idioma',
    'cv.version': 'Versión',
    'cv.fileSize': 'Tamaño',
    'cv.additionalInfo': 'Información adicional',
    'cv.skills': 'Habilidades',
    'cv.experience': 'Experiencia',
    'cv.yearsExperience': 'años de experiencia',
    'cv.loading': 'Cargando CV...',
    
    // CV Admin
    'cv.admin.title': 'Gestión de CVs',
    'cv.admin.subtitle': 'Administra los documentos de hoja de vida',
    'cv.admin.newCV': 'Nuevo CV',
    'cv.admin.createCV': 'Crear nuevo CV',
    'cv.admin.editCV': 'Editar CV',
    'cv.admin.cvTitle': 'Título',
    'cv.admin.cvDescription': 'Descripción',
    'cv.admin.fileName': 'Nombre del archivo',
    'cv.admin.fileUrl': 'URL del archivo',
    'cv.admin.fileSize': 'Tamaño del archivo (bytes)',
    'cv.admin.language': 'Idioma',
    'cv.admin.version': 'Versión',
    'cv.admin.isActive': 'CV activo',
    'cv.admin.saveCV': 'Guardar CV',
    'cv.admin.updateCV': 'Actualizar CV',
    'cv.admin.cancel': 'Cancelar',
    'cv.admin.delete': 'Eliminar',
    'cv.admin.edit': 'Editar',
    'cv.admin.download': 'Descargar',
    'cv.admin.active': 'Activo',
    'cv.admin.inactive': 'Inactivo',
    'cv.admin.noCVs': 'No hay CVs registrados',
    'cv.admin.createFirst': 'Comienza creando tu primer CV',
    'cv.admin.createFirstButton': 'Crear primer CV',
    'cv.admin.loading': 'Cargando CVs...',
    'cv.admin.deleteConfirm': '¿Estás seguro de que quieres eliminar este CV?',
    'cv.admin.successCreate': 'CV creado exitosamente',
    'cv.admin.successUpdate': 'CV actualizado exitosamente',
    'cv.admin.successDelete': 'CV eliminado exitosamente',
    'cv.admin.errorSave': 'Error al guardar el CV',
    'cv.admin.errorDelete': 'Error al eliminar el CV'
  },
  en: {
    // Navigation
    'nav.home': 'Home',
    ...
    // CV Module
    'cv.title': 'CV - Resume',
    'cv.subtitle': 'My professional experience and skills',
    'cv.download': 'Download',
    'cv.share': 'Share',
    'cv.email': 'Send by email',
    'cv.fullscreen': 'Fullscreen',
    'cv.exitFullscreen': 'Exit fullscreen',
    'cv.notAvailable': 'CV not available',
    'cv.notFound': 'No active CV found.',
    'cv.backToHome': 'Back to home',
    ...
    // CV Admin
    'cv.admin.title': 'CV Management',
    'cv.admin.subtitle': 'Manage resume documents',
    'cv.admin.newCV': 'New CV',
    'cv.admin.createCV': 'Create new CV',
    'cv.admin.editCV': 'Edit CV',
    'cv.admin.cvTitle': 'Title',
    'cv.admin.cvDescription': 'Description',
    'cv.admin.fileName': 'File name',
    'cv.admin.fileUrl': 'File URL',
    'cv.admin.fileSize': 'File size (bytes)',
    'cv.admin.language': 'Language',
    'cv.admin.version': 'Version',
    'cv.admin.isActive': 'Active CV',
    'cv.admin.saveCV': 'Save CV',
    'cv.admin.updateCV': 'Update CV',
    'cv.admin.cancel': 'Cancel',
    'cv.admin.delete': 'Delete',
    'cv.admin.edit': 'Edit',
    'cv.admin.download': 'Download',
    'cv.admin.active': 'Active',
    'cv.admin.inactive': 'Inactive',
    'cv.admin.noCVs': 'No CVs registered',
    'cv.admin.createFirst': 'Start by creating your first CV',
    'cv.admin.createFirstButton': 'Create first CV',
    'cv.admin.loading': 'Loading CVs...',
    'cv.admin.deleteConfirm': 'Are you sure you want to delete this CV?',
    'cv.admin.successCreate': 'CV created successfully',
    'cv.admin.successUpdate': 'CV updated successfully',
    'cv.admin.successDelete': 'CV deleted successfully',
    'cv.admin.errorSave': 'Error saving CV',
    'cv.admin.errorDelete': 'Error deleting CV'
  }
}
