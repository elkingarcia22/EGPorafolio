...
('Elkin Mac', 'Senior UX/UI Designer', 'Diseñador UX/UI Senior con más de 5 años de experiencia creando experiencias digitales excepcionales. Especializado en diseño centrado en el usuario, investigación UX y desarrollo de productos digitales innovadores.', 'hello@ejemplo.com', '+54 11 1234-5678', 'Buenos Aires, Argentina', 'https://linkedin.com/in/elkinmac', 'https://github.com/elkinmac');
...
('admin@ejemplo.com', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Administrador', 'admin');
