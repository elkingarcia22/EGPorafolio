-- =====================================================
-- SISTEMA DE PÁGINAS DE PROYECTOS ESTILO BEHANCE
-- =====================================================
...
COMMENT ON TABLE projects IS 'Proyectos principales del portafolio';
COMMENT ON TABLE project_sections IS 'Secciones flexibles dentro de cada proyecto (como Behance)';
COMMENT ON TABLE project_elements IS 'Elementos individuales dentro de las secciones (texto, imagen, video, etc.)';
COMMENT ON TABLE project_images IS 'Imágenes asociadas a proyectos';
COMMENT ON TABLE project_videos IS 'Videos asociados a proyectos';
COMMENT ON TABLE project_categories IS 'Categorías de proyectos';
COMMENT ON TABLE project_tags IS 'Tags/etiquetas de proyectos';

COMMENT ON COLUMN projects.slug IS 'URL amigable del proyecto';
COMMENT ON COLUMN projects.status IS 'Estado del proyecto: draft, published, archived';
COMMENT ON COLUMN projects.featured IS 'Si el proyecto aparece destacado';
COMMENT ON COLUMN project_sections.section_type IS 'Tipo de sección: hero, text, image, video, gallery, etc.';
COMMENT ON COLUMN project_elements.element_type IS 'Tipo de elemento: heading, paragraph, image, video, etc.';
COMMENT ON COLUMN project_elements.content IS 'Contenido flexible en formato JSON';
COMMENT ON COLUMN project_elements.styling IS 'Estilos personalizados en formato JSON';
