      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-4xl font-extrabold text-gray-900 dark:text-white">
            Test Final - Verificación de Estilos
          </h1>
          <button
            onClick={toggleTheme}
        ...
        <div className="space-y-8">
          {/* Test 1: Comparación directa de colores */}
          ...
          {/* Test 2: Colores directos para comparación */}
          ...
          {/* Test 3: Botones con diferentes estilos */}
          ...
          {/* Test 5: Instrucciones para verificar */}
          ...
          {/* Test 6: Verificación de especificidad CSS */}
          <div className="bg-blue-100 dark:bg-blue-900/20 p-6 rounded-lg border border-blue-300 dark:border-blue-700">
            ...
            <div className="space-y-4">
              <div className="bg-white dark:bg-gray-800 p-4 rounded border">
                <p className="text-gray-600 dark:text-gray-300">
                  <strong>Clase:</strong> dark:bg-gray-800<br/>
                  <strong>Especificidad:</strong> 0,0,1,1 (elemento + clase)<br/>
                  <strong>Color:</strong> rgb(31 41 55)
                </p>
              </div>
              <div className="bg-white dark:bg-dark-surface p-4 rounded border">
                <p className="text-gray-600 dark:text-gray-300">
                  <strong>Clase:</strong> dark:bg-dark-surface<br/>
                  <strong>Especificidad:</strong> 0,0,1,1 + !important<br/>
                  <strong>Color:</strong> #121212
                </p>
              </div>
            </div>
          </div>
