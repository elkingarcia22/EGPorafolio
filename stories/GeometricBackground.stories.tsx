      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen">
        <div className="text-center max-w-4xl mx-auto px-8">
          <h1 className="text-6xl font-bold text-gray-800 dark:text-white mb-6">
            Fondo Geométrico Neumórfico
          </h1>
          <p className="text-xl text-gray-600 dark:text-gray-300 mb-8">
            Formas geométricas elegantes con estilo neumórfico ubicadas en el lado derecho.
            Círculos y rectángulos que flotan suavemente creando un ambiente moderno y minimalista.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl mx-auto">
            <div className="p-6 rounded-2xl" style={{
              ...
              <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-2">Formas Limpias</h3>
              <p className="text-sm text-gray-600 dark:text-gray-300">Círculos y rectángulos con bordes suaves y sombras perfectas</p>
            </div>
            <div className="p-6 rounded-2xl" style={{
              background: '#f0f0f3',
              boxShadow: '20px 20px 40px #d1d9e6, -20px -20px 40px #ffffff'
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300">Movimientos flotantes con diferentes velocidades para naturalidad</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen">
        <div className="text-center max-w-3xl mx-auto px-8">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 mb-8">
            Observa las formas neumórficas flotando suavemente en el lado derecho
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-2xl mx-auto">
            <div className="p-4 rounded-xl" style={{
              ...
              <h4 className="font-semibold text-gray-800 dark:text-white mb-2">Círculos</h4>
              <p className="text-sm text-gray-600 dark:text-gray-300">Formas redondas con sombras suaves</p>
            </div>
            <div className="p-4 rounded-xl" style={{
              background: '#f0f0f3',
              boxShadow: '8px 8px 16px #d1d9e6, -8px -8px 16px #ffffff'
            }}>
              <h4 className="font-semibold text-gray-800 dark:text-white mb-2">Rectángulos</h4>
              <p className="text-sm text-gray-600 dark:text-gray-300">Formas cuadradas con bordes redondeados</p>
            </div>
            <div className="p-4 rounded-xl" style={{
              background: '#f0f0f3',
              boxShadow: '8px 8px 16px #d1d9e6, -8px -8px 16px #ffffff'
